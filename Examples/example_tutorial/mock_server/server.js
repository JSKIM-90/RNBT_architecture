/**
 * Tutorial Dashboard - Mock API Server
 *
 * 교육용 대시보드 예제를 위한 Mock API 서버
 *
 * Endpoints:
 * - GET /api/user       : 사용자 정보 (MASTER)
 * - GET /api/menu       : 네비게이션 메뉴 (MASTER)
 * - GET /api/stats      : 통계 카드 데이터 (PAGE)
 * - GET /api/sales      : 판매 테이블 데이터 (PAGE)
 * - GET /api/trend      : 트렌드 차트 데이터 (PAGE)
 *
 * Port: 3003
 */
...
/**
 * GET /api/stats
 * StatsCards 컴포넌트용 통계 데이터
 */
app.get('/api/stats', (req, res) => {
    // 매 호출마다 약간의 변동을 주어 실시간 갱신 효과
